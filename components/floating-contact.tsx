  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <motion.button
        ...
        className="relative w-14 h-14 rounded-full bg-linear-to-br from-violet-600 to-blue-600 text-white shadow-2xl shadow-violet-500/40 flex items-center justify-center focus:outline-none"
      >
        {/* Ping ring */}
        {!open && (
